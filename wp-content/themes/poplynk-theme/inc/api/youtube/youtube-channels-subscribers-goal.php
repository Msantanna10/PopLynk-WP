...
function youtube_channel_subscribers_callback($request) {
    ...
    if($method == 'POST') {
        ...
        if ($channel_reward_file) {
            ...
            $channel_reward_file = $upload_document['file_id'];
        }
        ...
        $channel_reward_expiration = ($request['reward_expiration']) ? esc_sql($request['reward_expiration']) : null;
        ...
        else if (isset($request['reward_expiration']) && $request['reward_expiration'] === '') {
        ...
        if($has_progress) {
            ...
            if ($last_progress_index !== -1) {
                ...
                // Upload file and return its ID
                if($channel_reward_file !== null) {
                    $channel_subscriber_goals[$last_progress_index]['file'] = $channel_reward_file;
                }

                // Expiration
                if($channel_reward_expiration !== null) {
